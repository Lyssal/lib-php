...
abstract class AbstractText
{
     ...
     *
     * @return \Lyssal\Text\AbstractText The Lyssal Text instance
     */
     ...
     *
     * @see https://stackoverflow.com/questions/1401317/remove-non-utf8-characters-from-string#answer-1401716
     *
     * @return \Lyssal\Text\AbstractText The Lyssal Text instance
     */
    public function tryToRemoveInvalidCharacters(): self
    {
        $regex = <<<'END'
/
  (
...
END;
     ...
     * @return \Lyssal\Text\AbstractText The Lyssal Text instance
     */
    public function removeNonPrintableCharacters(): self
    {
